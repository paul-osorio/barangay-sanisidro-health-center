...
<form action="<?= base_url('PatientAuth/addappointment') ?>" method="POST" id="mainform">
    ...
    <div class="cont" style="margin-top: 5rem">
        ...
        <input type="text" value="others" name="profiletype" hidden>
            ...
            <div class="col-lg-12">
                <div class="card card-body border-0 mainc" style="border-radius: 10px">
                    ...
                    <div class="d-flex justify-content-between">
                        <label class="lblback fs-5" onclick="location.href='<?= base_url('P/ForOthers') ?>'"><i class="fad fa-arrow-left"></i></label>

                        <div class="d-flex align-items-center">
                            <?= othersIcon(25, 25) ?>
                            <p class="fs-5 ms-1 text-primary mb-0">FOR OTHERS</p>
                        </div>
                        <div class=""></div>
                    </div>
                    <!-- TITLE -->
                                ...
                                ?>
                                    <div class="col-lg-6">
                                        ...
                                        ?>
                                            ...
                                            <label for="" class="text-danger">This profile has pending prenatal appointment. Cancel the appointment to set a new one.</label>
