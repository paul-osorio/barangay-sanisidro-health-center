<style>
    ...
    .prenatal {
        background-image: url("<?= base_url('assets/images/preg.jpg') ?>");
...
<form action="<?= base_url('PatientAuth/addappointment') ?>" method="POST" id="mainform">
    ...
    <div class="cont" style="margin-top: 5rem">
        ...
        <input type="text" value="myself" name="profiletype" hidden>
                ...
                <div class="card card-body border-0 mainc" style="border-radius: 10px">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <?= myselfIcon(25, 25) ?>
                            <p class="fs-5 ms-1 text-primary mb-0">FOR MYSELF</p>
                        </div>
                        <div class=""></div>
                    </div>
                    <!-- TITLE -->
                            ...
                            <div class="row">
                                ...
                                ?>
                                    <div class="col-lg-6">
                                        ...
                                        $res1 = $this->Patient_model->myselfExist($dataarr1);
                                        if ($res1->num_rows() > 0) {
                                        ?>
                                            <div class="position-relative">

                                                <input type="radio" name="type" id="" value="" class="position-absolute symcheck d-block mb-2 form-check-input">
                                                <label for="prenatal" class="prenataldis w-100  position-relative">
                                                    <i class="fas fa-badge-check position-absolute checka"></i>

                                                    <div class="prenataltxt d-flex ">
                                                        <p class="txt1 fw-bold text-white fs-1 mb-0 px-3 ">PRENATAL</p>
                                                    </div>
                                                </label>
                                            </div>

                                            <label for="" class="text-danger">You already set a prenatal appointment. Cancel your previous appointment to set a new one.</label>
                                        ...
                                        ?>
                                            <div class="position-relative">
                                                ...
                                                <input type="radio" name="type" id="prenatal" value="prenatal" class="position-absolute symcheck d-block mb-2 form-check-input">
                                                <label for="prenatal" class="prenatal w-100 position-relative">
                                                    <i class="fas fa-badge-check position-absolute checka"></i>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    $res = $this->Patient_model->myselfExist($dataarr);
                                    if ($res->num_rows() > 0) {
                                    ?>
                                        <div class="position-relative">
                                        ...
                                        <label for="" class="text-danger">You already set a dental appointment. Cancel your previous appointment to set a new one.</label></label>
                    ...
                    <div class="secondcard position-relative">
                        ...
                        <div class="prenatalnext mt-3">
                            <div class="d-flex align-items-center mb-2">
                                <p class="text-secondary fs-5 fw-bold mb-0">Select Prenatal Services</p>
                                <label class="text-danger ms-3" style="font-size: 14px" id="prenatalerror"><i class="fas fa-exclamation-square"></i> Please select prenatal services</label>
                            </div>
                            <div class="" style="overflow-y: auto; height: 20rem;overflow-x: hidden">

                                <div class="row gy-2">
                                    <?php
                                    $prenatalres = $this->db->query('SELECT * FROM prenatal');
                                    foreach ($prenatalres->result_array() as $data) {
                                    ?>
                                        <div class="col-lg-4">
                                            <div class="position-relative d-flex align-items-center checkcard">
                                                <input type="checkbox" id="prenatal<?= $data['ID'] ?>" value="<?= $data['Name'] ?>" name="imm" class="position-absolute imcheck">
                                                <label for="prenatal<?= $data['ID'] ?>" id="customcb"><i class="far fa-circle text-secondary"></i></label>
                                                <label for="prenatal<?= $data['ID'] ?>" id="customcb1" class="d-none"><i class="fas text-white fa-check-circle"></i></label>
                                                <label for="prenatal<?= $data['ID'] ?>" class="imcheckcard">
