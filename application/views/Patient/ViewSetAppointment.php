            ...
            <div class="card card-body" style="box-shadow: 0 4px 4px rgba(0,0,0,0.1)">
                ...
                <div class="row">
                    <div class="col-lg-4 position-relative">
                        ...
                        <?php
                        $sel = $this->db->query('SELECT * FROM appointment WHERE ID=' . $appoint['appID'])->row_array();
                        if ($sel['status'] !== "complete") {
                        ?>
                            <div class="position-absolute w-100 bottom-0 pe-4">
                                <button class="setbtn w-100" onclick="location.href='<?= base_url('Patient/printdocc/' . $appoint['ID']) ?>'" type="button">Print</button>
                            </div>
                        <?php
                        }
                        ?>
...
<td><button type="submit" <?php $status = 'pending';
                            if ($status == 'Pending') {
                                echo 'disabled';
                            }

                            if ($status == 'Pending for cancellation') {
                                echo 'disabled';
                            }
                            if ($status == 'Cancelled') {
                                echo 'disabled';
                                ...
                                echo '';
                            } ?> onclick="location.href='cancel.php?getid=<?php echo $row['ID']; ?>'">Cancel</button>
</td>