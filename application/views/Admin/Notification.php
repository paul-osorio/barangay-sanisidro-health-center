...
<script>
    $(document).ready(function() {
        ...
        function fetchnotification(start) {
            $.ajax({
                url: '<?= base_url('AdminAuth/fetchNotification') ?>',
                method: "POST",
                data: {
                    start: start,
                },
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            html += '<a href="' + base_url + '/Admin/ViewNotification/' + data[i].id + '" class="text-decoration-none text-dark">'
